...
public class StringManipulation {
	...
	//trim() -- would trim any leading and trailing spaces for a string
	s = "        welcome to java       ";
	...
	// equals(0, equalsIgnorCase() --> compares two strings and returns true/false
	...
	//split() -- split or divide original string in to multiple parts based on delimiter
	s = "abc@xyz";
	String a[] = s.split("@");
